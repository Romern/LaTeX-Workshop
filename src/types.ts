...
export type FileCache = {
    ...
    /** The paths of extra dependency files declared via the
     * `% !TeX dependency = ...` magic comment. These are watched so that a
     * change triggers an auto build, but they are not parsed as LaTeX. */
